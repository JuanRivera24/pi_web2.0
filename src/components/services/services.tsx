...
export default function ServicesAccordion() {
  ...
  return (
    // MEJORA: Aplicamos el tema oscuro consistente
    <section id="servicios" className="w-full bg-gray-900 text-white py-20">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {/* --- VISTA PARA ESCRITORIO (con la animación original y tema oscuro) --- */}
                  ...
                  >
                    <div className="w-full bg-black/40 backdrop-blur-md rounded-xl p-5 ring-1 ring-white/20">
                      ...
                      <div className="mt-4 flex flex-wrap gap-3">
                        ...
                        {/* Se mantiene este botón para coherencia con el original */}
        ...
        {/* --- VISTA PARA MÓVIL (con tema oscuro) --- */}
            ...
            <div key={service.id} className="relative h-72 rounded-2xl overflow-hidden shadow-lg ring-1 ring-white/10 bg-gray-800">
              ...
              <div className="absolute inset-x-0 bottom-0 p-6">
                ...
                <div className="mt-4 flex gap-3">
                  <Link href="/#citas" className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded-lg transition text-sm">
                    Reservar
                  </Link>
