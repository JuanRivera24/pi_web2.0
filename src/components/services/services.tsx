...
const services = [
{ id: 1, title: "Corte Clásico", description: "Un corte limpio y elegante para todo tipo de ocasión.", image: "/images/corte-clasico.jpg" },
{ id: 2, title: "Fade Moderno", description: "El degradado perfecto que marca tendencia.", image: "/images/fade.jpg" },
{ id: 3, title: "Barba Perfilada", description: "Diseño y perfilado para resaltar tu estilo.", image: "/images/barba.jpg" },
{ id: 4, title: "Afeitado Premium", description: "Afeitado con toalla caliente y productos de calidad.", image: "/images/afeitado.jpg" },
{ id: 5, title: "Color y Tintura", description: "Personaliza tu look con color y estilo.", image: "/images/color.jpg" },
];
              ...
              >
                <div className="w-full bg-black/35 backdrop-blur-sm rounded-xl p-5 ring-1 ring-white/20">
                  ...
                  <div className="mt-4 flex flex-wrap gap-3">
                    <Link href="/#citas" className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded-lg transition">
                      Reservar ahora
                    </Link>
        ...
        <div key={service.id} className="relative h-72 rounded-2xl overflow-hidden shadow-md ring-1 ring-gray-200 bg-white">
          ...
          <div className="absolute inset-x-0 bottom-0 p-5">
            ...
            <div className="mt-3 flex gap-3">
              <Link href="/#citas" className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-2 rounded-lg transition">
                Reservar
              </Link>
